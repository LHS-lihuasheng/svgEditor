 ...
 * 统一注册和导出所有组件模板
 */
import { SVG_PIC_TEMPLATE, SVG_SEAMLESS_TEMPLATE } from './svgTemplate';
...
import { NORMAL_SECTION_TEMPLATE, ZERO_HEIGHT_SECTION_TEMPLATE, OVERFLOW_SECTION_TEMPLATE } from './sectionTemplate';
import { BaseComponentTemplate } from '@/types/component';
import { FO_PICTURE_TEMPLATE } from './foSvg';

// 注册所有组件模板
export const COMPONENT_TEMPLATES: BaseComponentTemplate[] = [
  SVG_PIC_TEMPLATE,
  SVG_SEAMLESS_TEMPLATE,
  GROUP_TEMPLATE,
  RECT_TEMPLATE,
  SET_TEMPLATE,
  ANIMATE_TEMPLATE,
  ...
  NORMAL_SECTION_TEMPLATE,
  ZERO_HEIGHT_SECTION_TEMPLATE,
  OVERFLOW_SECTION_TEMPLATE,
  FO_PICTURE_TEMPLATE
];